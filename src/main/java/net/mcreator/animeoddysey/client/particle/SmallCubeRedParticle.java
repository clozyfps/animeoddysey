				...
				private class SmallCubeRedRenderer {
					...
					public void render(RenderLevelStageEvent event) {
						if (event.getStage() == RenderLevelStageEvent.Stage.AFTER_PARTICLES) {
							VertexConsumer consumer = Minecraft.getInstance().renderBuffers().bufferSource().getBuffer(RenderType.entityTranslucentEmissive(new ResourceLocation("animeoddysey:textures/particle/small_cube_red.png")));
