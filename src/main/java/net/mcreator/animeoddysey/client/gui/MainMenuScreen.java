...
public class MainMenuScreen extends AbstractContainerScreen<MainMenuMenu> {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font,
				...
				StrengthDisplayProcedure.execute(), -208, 25, -1, false);
		guiGraphics.drawString(this.font,

				DefenseDisplayProcedure.execute(), -208, 43, -1, false);
		guiGraphics.drawString(this.font,

				AgilityDisplayProcedure.execute(), -208, 61, -1, false);
		guiGraphics.drawString(this.font,

				EnergyValueProcedure.execute(), -208, 79, -1, false);
		guiGraphics.drawString(this.font,

				RankValueProcedure.execute(), -208, 106, -1, false);
		guiGraphics.drawString(this.font,

				LevelValueProcedure.execute(), -208, -11, -1, false);
		guiGraphics.drawString(this.font,

				SPValueProcedure.execute(), -208, 7, -1, false);
	}
