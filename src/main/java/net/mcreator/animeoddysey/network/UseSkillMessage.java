...
import net.mcreator.animeoddysey.procedures.UseSkillOnKeyPressedProcedure;
...
public class UseSkillMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		AnimeoddyseyMod.addNetworkMessage(UseSkillMessage.class, UseSkillMessage::buffer, UseSkillMessage::new, UseSkillMessage::handler);
	}
}
