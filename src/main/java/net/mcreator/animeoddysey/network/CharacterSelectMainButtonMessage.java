...
import net.mcreator.animeoddysey.procedures.OpenOnePieceProcedure;
import net.mcreator.animeoddysey.procedures.OpenNarutoProcedure;
...
public class CharacterSelectMainButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 5) {
			...
			OpenOnePieceProcedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 6) {
