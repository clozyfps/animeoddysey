...
import net.mcreator.animeoddysey.procedures.SwitchSkillOnKeyPressedProcedure;
...
public class SwitchSkillMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		AnimeoddyseyMod.addNetworkMessage(SwitchSkillMessage.class, SwitchSkillMessage::buffer, SwitchSkillMessage::new, SwitchSkillMessage::handler);
	}
}
