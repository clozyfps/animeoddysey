 ...
 *
 */
package net.mcreator.animeoddysey;
...
import net.mcreator.animeoddysey.init.AnimeoddyseyModMenus;
...
@Mod("animeoddysey")
public class AnimeoddyseyMod {
	public static final Logger LOGGER = LogManager.getLogger(AnimeoddyseyMod.class);
	public static final String MODID = "animeoddysey";

	public AnimeoddyseyMod() {
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		AnimeoddyseyModSounds.REGISTRY.register(bus);
		...
		AnimeoddyseyModParticleTypes.REGISTRY.register(bus);

		AnimeoddyseyModMenus.REGISTRY.register(bus);
	}
