...
import net.mcreator.animeoddysey.procedures.DismantleProjectileWhileProjectileFlyingTickProcedure;
...
public class DismantleProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public DismantleProjectileEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(AnimeoddyseyModEntities.DISMANTLE_PROJECTILE.get(), world);
	}
	...
	public static DismantleProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source) {
		return shoot(world, entity, source, 2f, 5, 0);
	}

	public static DismantleProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		DismantleProjectileEntity entityarrow = new DismantleProjectileEntity(AnimeoddyseyModEntities.DISMANTLE_PROJECTILE.get(), entity, world);
	...
	public static DismantleProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		DismantleProjectileEntity entityarrow = new DismantleProjectileEntity(AnimeoddyseyModEntities.DISMANTLE_PROJECTILE.get(), entity, entity.level());
