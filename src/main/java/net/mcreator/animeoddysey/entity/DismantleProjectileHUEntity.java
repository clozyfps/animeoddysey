...
import net.mcreator.animeoddysey.procedures.DismantleProjectileHUWhileProjectileFlyingTickProcedure;
import net.mcreator.animeoddysey.procedures.DismantleProjectileHUProjectileHitsLivingEntityProcedure;
