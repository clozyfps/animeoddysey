		...
		if (((sourceentity.getCapability(AnimeoddyseyModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new AnimeoddyseyModVariables.PlayerVariables())).Character).equals("Nanami")) {
			if (entity instanceof NanamiHitEntity) {
				...
				if (Mth.nextInt(RandomSource.create(), 1, 2) == 1) {
					if (world instanceof ServerLevel _level) {
						Entity entityToSpawn = AnimeoddyseyModEntities.NANAMI_HIT.get().spawn(_level,
								BlockPos.containing(x + Mth.nextInt(RandomSource.create(), (int) 0.5, (int) 0.5), y + 1.5, z + Mth.nextInt(RandomSource.create(), (int) 0.5, (int) 0.5)), MobSpawnType.MOB_SUMMONED);
