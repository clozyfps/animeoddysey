...
public class PostMortemUnlockProcedure {
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1) <= 2) {
			if (!(entity instanceof ServerPlayer _plr1 && _plr1.level() instanceof ServerLevel && _plr1.getAdvancements().getOrStartProgress(_plr1.server.getAdvancements().getAdvancement(new ResourceLocation("animeoddysey:post_mortem"))).isDone())) {
